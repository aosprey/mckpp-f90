...
C    ******
C             26-10-99   Version 2.4   Jean Latour (F.S.E.) MPI-2 support
C@
...
C
      INTEGER*4 CLIM_jpmax, 	CLIM_jpmx8, 	CLIM_Mpi
C
C-----Parameter sizes
C
      PARAMETER ( CLIM_Void    = 0  )
      PARAMETER ( CLIM_MaxMod  = 8 )
      PARAMETER ( CLIM_MaxPort = 22 )
...
C
C-----Dimension of buffer for packing / unpacking messages with MPI
C     (must be equal to jpmax of Oasis)
C
      PARAMETER ( CLIM_jpmax = 220000 )
